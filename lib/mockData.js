...
export const leaderboardData = [
  { rank: 1, name: "Priya Sharma", dept: "Capital Markets", toolsDone: 8, hoursSaved: 67.5, points: 4250, badge: "Champion" },
  { rank: 2, name: "James Mitchell", dept: "Technology", toolsDone: 7, hoursSaved: 58.2, points: 3890, badge: "Champion" },
  { rank: 3, name: "Sarah Chen", dept: "Compliance & Risk", toolsDone: 7, hoursSaved: 54.0, points: 3720, badge: "Champion" },
...
export const badges = [
  ...
  { id: "spark-champion", name: "SPARK Champion", icon: "👑", description: "Top 10 on leaderboard", unlockCondition: "top10" },
];
