export const tools = [
  {
    ...
    videoUrl: "https://www.youtube.com/embed/JbOJliF-Cn4",
    walkthroughVideoUrl: "https://www.youtube.com/embed/JbOJliF-Cn4",
  },
  {
    id: "github-copilot",
    name: "GitHub Copilot",
    ...
    videoUrl: "https://www.youtube.com/embed/n0NlxUyA7FI",
    walkthroughVideoUrl: "https://www.youtube.com/embed/n0NlxUyA7FI",
  },
  {
    id: "copilot-studio",
    ...
    videoUrl: "https://www.youtube.com/embed/dX9MJM5EokE",
    walkthroughVideoUrl: "https://www.youtube.com/embed/dX9MJM5EokE",
  },
  {
    id: "power-automate",
    ...
    videoUrl: "https://www.youtube.com/embed/lA3Mh84K5fM",
    walkthroughVideoUrl: "https://www.youtube.com/embed/lA3Mh84K5fM",
  },
  {
    id: "azure-openai",
    ...
    videoUrl: "https://www.youtube.com/embed/jQyYeYWD97I",
    walkthroughVideoUrl: "https://www.youtube.com/embed/jQyYeYWD97I",
  },
  {
    id: "copilot-data",
    ...
    videoUrl: "https://www.youtube.com/embed/KXqR6VuPBlk",
    walkthroughVideoUrl: "https://www.youtube.com/embed/KXqR6VuPBlk",
  },
  {
    id: "copilot-comms",
    ...
    videoUrl: "https://www.youtube.com/embed/RY1NRd-aoyI",
    walkthroughVideoUrl: "https://www.youtube.com/embed/RY1NRd-aoyI",
  },
  {
    ...
    videoUrl: "https://www.youtube.com/embed/8cNx45-3pMU",
    walkthroughVideoUrl: "https://www.youtube.com/embed/8cNx45-3pMU",
  },
  {
    id: "copilot-word",
    ...
    videoUrl: "https://www.youtube.com/embed/phpBb_GXITI",
    walkthroughVideoUrl: "https://www.youtube.com/embed/phpBb_GXITI",
  },
  {
    id: "copilot-pptx",
    ...
    videoUrl: "https://www.youtube.com/embed/Yq6JlVrs-IU",
    walkthroughVideoUrl: "https://www.youtube.com/embed/Yq6JlVrs-IU",
  },
  {
    id: "cibc-ai",
    name: "CAI: CIBC AI",
    description: "CIBC’s internal generative AI assistant — get answers, drafts, and summaries aligned with bank policies, using approved data sources and safe-use guardrails",
    bestFor: ["All"],
    timeSaved: 25,
    difficulty: "Beginner",
    category: "Platform",
    color: "#C41F3E",
    socialProof: { name: "Jordan", initials: "JT", savings: "1.5 hrs/day", color: "#C41F3E" },
    whatIsIt: [
      "CAI (CIBC AI) is CIBC’s internal AI assistant designed for employees to work faster while staying inside approved boundaries. It helps with drafting, summarizing, brainstorming, and Q&A using patterns and content that fit CIBC’s standards — not a public chatbot.",
      "Use CAI when you want a starting point for internal communications, policy-aligned wording, or structured summaries, while keeping sensitive client information out of prompts. It complements tools like Microsoft 365 Copilot by giving you a CIBC-focused entry point for everyday AI help.",
      "Always treat CAI output as a draft: verify facts, follow your line-of-business rules, and escalate when advice could affect clients, risk, or regulatory obligations."
    ],
    bestUsedFor: [
      "Quick internal Q&A and short drafts that follow safe-use expectations",
      "Summarizing or restructuring non-sensitive notes into clear bullets or emails",
      "Brainstorming headings, outlines, and next-step checklists before you refine in your primary tools"
    ],
    examples: [
      {
        scenario: "An employee needs a neutral internal email explaining a process change to their team",
        prompt: "Draft a concise internal email announcing [process change]. Tone: professional. Include: what’s changing, why, effective date, and where to get help. Do not include any client or account details.",
        output: "CAI produced a structured draft with placeholders for dates and links, ready to edit with official wording from the owning team."
      },
      {
        scenario: "A manager wants meeting notes turned into decisions and follow-ups",
        prompt: "Turn these sanitized meeting notes into: decisions made, action items with suggested owners, and open risks. Use bullet format.",
        output: "CAI organized the notes into clear sections so the manager could validate owners and timelines before sharing."
      },
      {
        scenario: "A partner needs a checklist before sending work for compliance review",
        prompt: "Create a short checklist for reviewing an internal memo before submission: accuracy, tone, citations, and data-handling reminders.",
        output: "CAI returned a practical checklist the partner could apply before routing to compliance."
      }
    ],
    quiz: [
      {
        question: "What is CAI (CIBC AI) intended for?",
        options: ["Public marketing without review", "Internal, policy-aware assistance with safe-use guardrails", "Accessing client account balances", "Bypassing approval workflows"],
        correct: 1
      },
      {
        question: "What should you never paste into CAI?",
        options: ["A desired output format", "Client names, account numbers, or personal information", "An internal project code name", "A bullet list structure"],
        correct: 1
      },
      {
        question: "What should you do before relying on CAI output?",
        options: ["Send it externally immediately", "Verify accuracy, apply policy, and refine for your audience", "Assume it is legal advice", "Skip manager review"],
        correct: 1
      }
    ],
    tasks: ["Draft a short internal announcement", "Summarize notes into actions and decisions", "Turn a rough outline into bullet talking points", "Generate a review checklist for a document", "Rewrite for a clearer, professional tone"],
    videoUrl: "https://www.youtube.com/embed/PDw3Uk9dN9k",
    walkthroughVideoUrl: "https://www.youtube.com/embed/PDw3Uk9dN9k",
  }
];
...
export const categoryColors = {
  Platform: { bg: "bg-red-100", text: "text-red-800", dot: "bg-cibc-red" },
